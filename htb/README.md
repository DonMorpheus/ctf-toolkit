...
| **Abducted** | Medium (Linux / Samba) | [`Abducted/`](Abducted/) — CVE-2026-4480 print `%J` → rclone → wide links → polkit smbd |
| **DevHub** | Linux (MCP / Jupyter) | [`DevHub/`](DevHub/) — CVE-2026-23744 MCPJam → Jupyter token → OpsMCP `ops._admin_dump` |
