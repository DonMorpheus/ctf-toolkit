...
- Linux privesc: sockets, capabilities, services on `127.0.0.1`
- Documenting solves and tooling for reuse

Currently building public lab scripts and write-ups (no live creds in repos).

[![HTB](https://img.shields.io/badge/HackTheBox-lab-orange)](https://www.hackthebox.com/)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
```

Edit badges and links to match your real HTB profile / LinkedIn when ready.